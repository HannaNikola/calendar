...
import { clearFilter, setFilterEntity, setFilterQuery } from "../store/filters/filterReducer";
...
dispatch(openModal({
  ...
  <div className={`flex items-center gap-2 bg-input-light px-3 py-2 w-full
